    ...
    >
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. Wheather you need stunning visuals or unique imaginary, our tool transforms your text into eye-catching images with just a few clicks. Imagine it, describe it come to life instantly.</p>
